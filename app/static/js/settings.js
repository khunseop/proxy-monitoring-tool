...
function getResourceConfigData() {
    ...
    const payload = {
        ...
        oids: {
            ...
            blocked: $('#cfgOidBlocked').val() || undefined,
        ...
        thresholds: {
            ...
            blocked: numOrUndef('#cfgThrBlocked'),
        },
...
function loadResourceConfig() {
    return $.get('/api/resource-config')
        .done(cfg => {
            ...
            $('#cfgOidBlocked').val(oids.blocked || '');
...
function applyPreset(type) {
    ...
    if (type === 'mwg') {
        ...
        $('#cfgOidHttp').val('1.3.6.1.4.1.21067.2.1.2.2.2.1.1');
        $('#cfgOidHttps').val('1.3.6.1.4.1.21067.2.1.2.2.2.2.1');
        $('#cfgOidHttp2').val('1.3.6.1.4.1.21067.2.1.2.2.2.3.1');
        $('#cfgOidBlocked').val('1.3.6.1.4.1.21067.2.1.2.1.2.3.1');
        ...
        if ($('#cfgInterfaceList tr').length === 0) {
            ...
            addInterfaceRow('bond0', { in_oid: '', out_oid: '' }, 800, 1000);
            addInterfaceRow('bond1', { in_oid: '', out_oid: '' }, 800, 1000);
        }
    } else if (type === 'linux') {
