...
3.  **OID 설정**: `설정` 메뉴에서 CPU, 메모리, HTTP2 등 수집할 자원 지표의 SNMP OID를 설정합니다. MWG 및 Linux 표준 프리셋을 제공하므로 버튼 클릭 한 번으로 자동 설정이 가능합니다.
4.  **백업 및 복구**: 모든 시스템 설정(장비, 그룹, OID 등)을 **Excel(.xlsx)** 파일로 백업하거나 복구할 수 있습니다. 비개발자도 엑셀에서 표 형태로 손쉽게 대량의 설정을 편집할 수 있습니다.
